...
router.get('/user/login', function(req, res, next) {
  res.render('login/W_login', {username: req.username});
})

router.get('/user/nregister', function(req, res, next) {
  res.render('login/x_login');
})


router.post('/user/logins', function(req, res, next) {
